...
?> 
    <div class="hero-wrap js-fullheight" style="background-image: url(<?=SITE_TEMPLATE_PATH . '/images/bg_1.jpg'?>);" data-stellar-background-ratio="0.5">
    	...
    	<div class="container">
    		<div class="row d-flex no-gutters">
    			<div class="col-md-6 d-flex">
    				<div class="img d-flex align-items-center justify-content-center py-5 py-md-0" style="background-image:url(<?=SITE_TEMPLATE_PATH  . '/images/about.jpg' ?> );" >
        ...
        <div class="container">
            ...
            <p><a href="#" class="btn btn-secondary">View All Staff</a></p>
                ...
                <div class="col-md-4 col-lg-3 ftco-animate d-flex">
                    <div class="staff">
                        <div class="img-wrap d-flex align-items-stretch">
                            <div class="img align-self-stretch" style="background-image: url(<?=SITE_TEMPLATE_PATH  . '/images/staff-1.jpg' ?> );"></div>
                        </div>
                ...
                <div class="col-md-4 col-lg-3 ftco-animate d-flex">
                    <div class="staff">
                        <div class="img-wrap d-flex align-items-stretch">
                            <div class="img align-self-stretch" style="background-image: url(<?=SITE_TEMPLATE_PATH  . '/images/staff-2.jpg' ?> );"></div>
                        </div>
                        <div class="text pt-3 px-3 pb-4 text-center">
                            <h3>Lloyd Wilson</h3>
                            <span class="position mb-2">Office Cleaner</span>
                ...
                <div class="col-md-4 col-lg-3 ftco-animate d-flex">
                    <div class="staff">
                        <div class="img-wrap d-flex align-items-stretch">
                            <div class="img align-self-stretch" style="background-image: url(<?=SITE_TEMPLATE_PATH  . '/images/staff-3.jpg' ?> );"></div>
                        </div>
                        <div class="text pt-3 px-3 pb-4 text-center">
                            <h3>Lloyd Wilson</h3>
                            <span class="position mb-2">Office Cleaner</span>
            ...
            <div class="carousel-testimony owl-carousel ftco-owl">
                ...
                <div class="testimony-wrap py-4">
                  ...
                  <div class="text">
                  	<div class="d-flex align-items-center mb-4">
                    	<div class="user-img" style="background-image: url(<?=SITE_TEMPLATE_PATH  . '/images/person_1.jpg' ?> )"></div>
                    	<div class="pl-3">
              ...
              <div class="item">
                <div class="testimony-wrap py-4">
                  ...
                  <div class="text">
                  	<div class="d-flex align-items-center mb-4">
                    	<div class="user-img" style="background-image: url(<?=SITE_TEMPLATE_PATH  . '/images/person_2.jpg' ?> )"></div>
                    	<div class="pl-3">
		                    <p class="name">Roger Scott</p>
		                    <span class="position">Marketing Manager</span>
		                  </div>
              ...
              <div class="item">
                <div class="testimony-wrap py-4">
                  ...
                  <div class="text">
                  	<div class="d-flex align-items-center mb-4">
                    	<div class="user-img" style="background-image: url(<?=SITE_TEMPLATE_PATH  . '/images/person_3.jpg' ?> )"></div>
                    	<div class="pl-3">
		                    <p class="name">Roger Scott</p>
		                    <span class="position">Marketing Manager</span>
		                  </div>
	...
	<section class="ftco-section ftco-no-pb">
		<div class="container">
          ...
          <div class="col-md-6 col-lg-3 ftco-animate">
            <div class="work img d-flex align-items-center" style="background-image: url(<?=SITE_TEMPLATE_PATH  . '/images/work-1.jpg' ?> );">
            	<a href="<?=SITE_TEMPLATE_PATH  . '/images/work-1.jpg' ?> " class="icon image-popup d-flex justify-content-center align-items-center">
          ...
          <div class="col-md-6 col-lg-3 ftco-animate">
            <div class="work img d-flex align-items-center" style="background-image: url(<?=SITE_TEMPLATE_PATH  . '/images/work-2.jpg' ?> );">
            	<a href="<?=SITE_TEMPLATE_PATH  . '/images/work-2.jpg' ?> " class="icon image-popup d-flex justify-content-center align-items-center">
	    					<span class="fa fa-expand"></span>
	    				</a>
            	<div class="desc w-100 px-4 text-center pt-5 mt-5">
	              <div class="text w-100 mb-3 mt-4">
          ...
          <div class="col-md-6 col-lg-3 ftco-animate">
            <div class="work img d-flex align-items-center" style="background-image: url(<?=SITE_TEMPLATE_PATH  . '/images/work-3.jpg' ?> );">
            	<a href="<?=SITE_TEMPLATE_PATH  . '/images/work-3.jpg' ?> " class="icon image-popup d-flex justify-content-center align-items-center">
	    					<span class="fa fa-expand"></span>
	    				</a>
            	<div class="desc w-100 px-4 text-center pt-5 mt-5">
	              <div class="text w-100 mb-3 mt-4">
          ...
          <div class="col-md-6 col-lg-3 ftco-animate">
            <div class="work img d-flex align-items-center" style="background-image: url(<?=SITE_TEMPLATE_PATH  . '/images/work-4.jpg' ?> );">
            	<a href="<?=SITE_TEMPLATE_PATH  . '/images/work-4.jpg' ?> " class="icon image-popup d-flex justify-content-center align-items-center">
	    					<span class="fa fa-expand"></span>
	    				</a>
            	<div class="desc w-100 px-4 text-center pt-5 mt-5">
	              <div class="text w-100 mb-3 mt-4">
          ...
          <div class="col-md-6 col-lg-3 ftco-animate">
            <div class="work img d-flex align-items-center" style="background-image: url(<?=SITE_TEMPLATE_PATH  . '/images/work-5.jpg' ?> );">
            	<a href="<?=SITE_TEMPLATE_PATH  . '/images/work-5.jpg' ?> " class="icon image-popup d-flex justify-content-center align-items-center">
	    					<span class="fa fa-expand"></span>
	    				</a>
            	<div class="desc w-100 px-4 text-center pt-5 mt-5">
	              <div class="text w-100 mb-3 mt-4">
          ...
          <div class="col-md-6 col-lg-3 ftco-animate">
            <div class="work img d-flex align-items-center" style="background-image: url(<?=SITE_TEMPLATE_PATH  . '/images/work-6.jpg' ?> );">
            	<a href="<?=SITE_TEMPLATE_PATH  . '/images/work-6.jpg' ?> " class="icon image-popup d-flex justify-content-center align-items-center">
	    					<span class="fa fa-expand"></span>
	    				</a>
            	<div class="desc w-100 px-4 text-center pt-5 mt-5">
	              <div class="text w-100 mb-3 mt-4">
          ...
          <div class="col-md-6 col-lg-3 ftco-animate">
            <div class="work img d-flex align-items-center" style="background-image: url(<?=SITE_TEMPLATE_PATH  . '/images/work-7.jpg' ?> );">
            	<a href="<?=SITE_TEMPLATE_PATH  . '/images/work-7.jpg' ?> " class="icon image-popup d-flex justify-content-center align-items-center">
	    					<span class="fa fa-expand"></span>
	    				</a>
            	<div class="desc w-100 px-4 text-center pt-5 mt-5">
	              <div class="text w-100 mb-3 mt-4">
          ...
          <div class="col-md-6 col-lg-3 ftco-animate">
            <div class="work img d-flex align-items-center" style="background-image: url(<?=SITE_TEMPLATE_PATH  . '/images/work-8.jpg' ?> );">
            	<a href="<?=SITE_TEMPLATE_PATH  . '/images/work-8.jpg' ?> " class="icon image-popup d-flex justify-content-center align-items-center">
	    					<span class="fa fa-expand"></span>
	    				</a>
            	<div class="desc w-100 px-4 text-center pt-5 mt-5">
	              <div class="text w-100 mb-3 mt-4">
        ...
        <div class="row d-flex">
          <div class="col-md-6 col-lg-4 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              <a href="blog-single.html" class="block-20 rounded" style="background-image: url('<?=SITE_TEMPLATE_PATH  . '/images/image_1.jpg' ?> ');">
              </a>
              <div class="text mt-3 px-4">
              	<div class="posted mb-3 d-flex">
              		<div class="img author" style="background-image: url(<?=SITE_TEMPLATE_PATH  . '/images/person_2.jpg' ?> );"></div>
              		<div class="desc pl-3">
          ...
          <div class="col-md-6 col-lg-4 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              <a href="blog-single.html" class="block-20 rounded" style="background-image: url('<?=SITE_TEMPLATE_PATH  . '/images/image_2.jpg' ?> ');">
              </a>
              <div class="text mt-3 px-4">
              	<div class="posted mb-3 d-flex">
              		<div class="img author" style="background-image: url(<?=SITE_TEMPLATE_PATH  . '/images/person_3.jpg' ?> );"></div>
              		<div class="desc pl-3">
              			<span>Posted by John doe</span>
              			<span>04 March 2020</span>
              		</div>
          ...
          <div class="col-md-6 col-lg-4 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              <a href="blog-single.html" class="block-20 rounded" style="background-image: url('<?=SITE_TEMPLATE_PATH  . '/images/image_3.jpg' ?> ');">
              </a>
              <div class="text mt-3 px-4">
              	<div class="posted mb-3 d-flex">
              		<div class="img author" style="background-image: url(<?=SITE_TEMPLATE_PATH  . '/images/person_1.jpg' ?> );"></div>
              		<div class="desc pl-3">
              			<span>Posted by John doe</span>
              			<span>04 March 2020</span>
              		</div>
    ...
    <section class="ftco-section ftco-intro" style="background-image: url(<?=SITE_TEMPLATE_PATH . '/images/bg_3.jpg'?>);" data-stellar-background-ratio="0.5">
    	<div class="overlay"></div>
    	<div class="container">
    		<div class="row justify-content-center">
