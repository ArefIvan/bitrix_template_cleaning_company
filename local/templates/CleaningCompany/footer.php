...
?>
 <footer class="footer ftco-section">
			<div class="container">
              ...
              <a class="img mr-4 rounded" style="background-image: url(<?=SITE_TEMPLATE_PATH . '/images/image_1.jpg' ?>);"></a>
              <div class="text">
            ...
            <div class="block-21 mb-4 d-flex">
              <a class="img mr-4 rounded" style="background-image: url(<?=SITE_TEMPLATE_PATH . '/images/image_2.jpg'?>);"></a>
              <div class="text">
                <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control about</a></h3>
                <div class="meta">
                  <div><a href="#"><span class="icon-calendar"></span> Mar. 04, 2020</a></div>
...
?>
  ...
  <script src="<?=SITE_TEMPLATE_PATH . '/js/scrollax.min.js ' ?> "></script>
